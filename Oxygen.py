...
CHATS = ['YehJannatHai', '-1002798371998']
...
if SESSION1:
    M1 = Client(SESSION1, api_id=22321019, api_hash="8746334865761149185b4263cc626e35")
else:
    M1 = None

if SESSION2:
    M2 = Client(SESSION2, api_id=22321019, api_hash="8746334865761149185b4263cc626e35")
else:
    M2 = None

if SESSION3:
    M3 = Client(SESSION3, api_id=22321019, api_hash="8746334865761149185b4263cc626e35")
else:
    M3 = None

if SESSION4:
    M4 = Client(SESSION4, api_id=22321019, api_hash="8746334865761149185b4263cc626e35")
else:
    M4 = None

if SESSION5:
    M5 = Client(SESSION5, api_id=22321019, api_hash="8746334865761149185b4263cc626e35")
else:
    M5 = None
